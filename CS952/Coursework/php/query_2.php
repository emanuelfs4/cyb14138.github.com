...
<div class="middle">
  <div id="container">
    <div id="latest">
      <section id="showcase">
        ...
        <div>
         <form method="post" action="https://devweb2014.cis.strath.ac.uk/~cyb14138/cyb14138.github.com/CS952/Coursework/php/query_2_out.php">
  ...
  <script language="javascript" type="text/javascript" src="../js/second_tab.js"> </script>
  <div class="bottom">
