...
<div class="middle">
  <div id="container">
    ...
    <p> This website it's being used as a temporary source to control and to have basic informations about the structure of its organization. </p>

    <p> The query tabs will display information as follow: <p>
   
    <h2><span><a href='./php/query_1.php'> Query 1</a></span></h2>
  
    <p> Will display information of all the supervisors who manages units bigger than the area entered by the user. Also, informations about the unit itself will be displayed.</p>

    <h2><span><a href='./php/query_2.php'> Query 2</a></span></h2>
