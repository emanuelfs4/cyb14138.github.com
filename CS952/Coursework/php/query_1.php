  ...
  <div id="container">
    ...
    <div id="latest">
      ...
      <section id="showcase">
        ...
        <p> Enter an area value and personal information of all the employees who manage sites in which units area are bigger than 
          the value entered by the user, and informations about the unit itself will be displayed.</p>
